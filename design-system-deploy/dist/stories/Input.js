...
export var Input = function (_a) {
    ...
    switch (type) {
        case "textInput":
            return (_jsx("div", __assign({ css: style({ width: width, theme: theme }) }, { children: _jsx("input", { css: textInputStyle(theme), placeholder: "Input Text", type: "text", name: name }) })));
        case "date":
            return (_jsx("div", __assign({ css: style({ width: width, theme: theme }) }, { children: _jsx("input", { css: textInputStyle(theme), type: "date", name: name }) })));
        case "phoneNumber":
            return (_jsx("div", __assign({ css: style({ width: width, theme: theme }) }, { children: _jsx("input", { css: textInputStyle(theme), type: "text", onChange: handlePress, value: inputValue, placeholder: "010-1234-5678", maxLength: 13 }) })));
        case "password":
            return (_jsxs("div", __assign({ css: style({ width: width, theme: theme }) }, { children: [_jsx("input", { type: passwordType, css: textInputStyle(theme), name: name }), _jsx("button", __assign({ onMouseDown: function () { return setPasswordType("text"); }, onMouseUp: function () { return setPasswordType("password"); }, style: { width: "16px", height: "16px", border: "none", outline: "none", background: "none" } }, { children: _jsx(Icon, { type: "eye" }) }))] })));
        case "searchField":
            return (_jsxs("div", __assign({ css: style({ width: width, theme: theme }) }, { children: [_jsx(Icon, { type: "magnifyingGlass" }), _jsx("input", { css: textInputStyle(theme), style: { paddingLeft: "16px" }, placeholder: "Search...", type: "text", name: name })] })));
        case "inputWithSteper":
            return (_jsxs("div", __assign({ css: style({ width: "80px", theme: theme }) }, { children: [_jsx("div", __assign({ css: textInputStyle(theme) }, { children: stepNumber })), _jsxs("div", __assign({ className: 'steperwrapper', css: steperWrapperStyle(theme) }, { children: [_jsx("button", __assign({ onClick: function () { return setStepNumber(function (prev) { return prev + 1; }); } }, { children: _jsx(Icon, { type: "angleUp" }) })), _jsx("button", __assign({ onClick: function () { return setStepNumber(function (prev) { return prev - 1; }); } }, { children: _jsx(Icon, { type: "angleDown" }) }))] }))] })));
        case "textAreaInput":
            return (_jsx("div", __assign({ css: textAreaStyle({ width: width, theme: theme }) }, { children: _jsx("textarea", { css: textAreaInputStyle({ height: height, theme: theme }), placeholder: "Input Text", name: name }) })));
        default:
            return null;
    }
};
...
var textAreaInputStyle = function (_a) {
