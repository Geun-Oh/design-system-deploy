...
var imgStyle = function (width, imgUrl) { return css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    width: ", "px;\n    height: ", "px;\n    padding: 1rem 1rem;\n    background: url(", ");\n    background-size: cover;\n    background-position: center center;\n    border-radius: 0 0 1.5rem 1.5rem;\n    display: flex;\n    flex-direction: column;\n    justify-content: flex-end;\n    align-items: center;\n    Button {\n        width: ", "px;\n        background: ", ";\n    }\n"], ["\n    width: ", "px;\n    height: ", "px;\n    padding: 1rem 1rem;\n    background: url(", ");\n    background-size: cover;\n    background-position: center center;\n    border-radius: 0 0 1.5rem 1.5rem;\n    display: flex;\n    flex-direction: column;\n    justify-content: flex-end;\n    align-items: center;\n    Button {\n        width: ", "px;\n        background: ", ";\n    }\n"])), width, width * 0.8, imgUrl, width, BaseStyles.Color.Beige1); };
